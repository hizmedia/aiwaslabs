        ...
        <div className="mt-auto pt-5 border-t border-[#dde4f0]">
          ...
          {status === 'added' ? (
            <div className="flex flex-col gap-2.5 w-full">
              ...
              <a
                href="/checkout"
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#02034a] px-6 py-[14px] font-poppins text-[14px] font-bold text-white shadow-[0_4px_16px_rgba(2,3,74,.18)] hover:bg-[#011B50] transition"
              >
